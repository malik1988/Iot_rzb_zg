...
#if RZB
//NRF24L01控制操作
#define NRF24L01_CE      		GPIO_Pin_3		//PA3
#define GPIO_NRF24L01_CE  		GPIOA
#define RCC_NRF24L01_CE  		RCC_AHB1Periph_GPIOA

#define NRF24L01_IRQ      		GPIO_Pin_8		//PA8
#define GPIO_NRF24L01_IRQ  		GPIOA
#define RCC_NRF24L01_IRQ  		RCC_AHB1Periph_GPIOA
#else
//NRF24L01控制操作
#define NRF24L01_CE      		GPIO_Pin_6		//PC6
#define GPIO_NRF24L01_CE  		GPIOC
#define RCC_NRF24L01_CE  		RCC_AHB1Periph_GPIOC

#define NRF24L01_IRQ      		GPIO_Pin_6		//PD6
...
//NRF24L01 SPI接口CS信号
#define NRF24L01_CSN      		GPIO_Pin_12		//PB12
...
#define RF_CHANNEL				0x01	//RFID通讯频段2400+RF_CHANNEL
//NRF24L01发送接收数据宽度定义
#define TX_ADR_WIDTH    5                               //5字节的地址宽度
#define RX_ADR_WIDTH    5                               //5字节的地址宽度
#define TX_PLOAD_WIDTH  10                              //20字节的用户数据宽度
#define RX_PLOAD_WIDTH  10                              //20字节的用户数据宽度
