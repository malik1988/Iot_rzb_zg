...
#endif
/* Includes ------------------------------------------------------------------*/
#include "stm322xg_SZW_fsmc_nor.h"
...
/** @addtogroup STM322xG_EVAL_FSMC_NOR
  * @{
  */ 

/** @defgroup STM322xG_EVAL_FSMC_NOR_Private_Types
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM322xG_SZW_EVAL_FSMC_NOR_Private_Defines
  * @{
  */ 
/** 
...
/** @defgroup STM322xG_SZW_EVAL_FSMC_NOR_Private_Macros
  * @{
  */
...
/** @defgroup STM322xG_SZW_EVAL_FSMC_NOR_Private_Variables
  * @{
  */ 
/**
  * @}
...
/** @defgroupSTM322xG_SZW_EVAL_FSMC_NOR_Private_Function_Prototypes
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM322xG_SZW_EVAL_FSMC_NOR_Private_Functions
  * @{
  */
...
/*
 ...
 +-------------------+--------------------+------------------+------------------+
 | PD0  <-> FSMC_D2  | PE2  <-> FSMC_A23  | PF0  <-> FSMC_A0 | PG0 <-> FSMC_A10 |
 | PD1  <-> FSMC_D3  | PE3  <-> FSMC_A19  | PF1  <-> FSMC_A1 | PG1 <-> FSMC_A11 |
 ...
 | PD6  <-> FSMC_NWAIT|PE4  <-> FSMC_A20  |
 | PD13 <-> FSMC_A18 | PE5  <-> FSMC_A21  |
 |                   | PE6  <-> FSMC_A22  |
 +-------------------+--------------------+
*/
  /* GPIOD configuration */
  ...
  /*-- FSMC Configuration ----------------------------------------------------*/
  p.FSMC_AddressSetupTime = 0x03;       //地址建立时间 3   
  p.FSMC_AddressHoldTime = 0x00;        //地址保持时间  
  p.FSMC_DataSetupTime = 0x05;          //数据建立时间 5
